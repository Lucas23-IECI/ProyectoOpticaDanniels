...
const SERVICIOS = [
  { id: "examen_visual", nombre: "Examen Visual", desc: "Evaluación completa de tu visión", icono: "👁️", duracion: "30 min" },
  { id: "asesoria_lentes", nombre: "Asesoría de Lentes", desc: "Encuentra los lentes perfectos para ti", icono: "👓", duracion: "30 min" },
  { id: "reparacion_marcos", nombre: "Reparación de Marcos", desc: "Reparamos tus marcos favoritos", icono: "🔧", duracion: "30 min" },
  { id: "adaptacion_contacto", nombre: "Adaptación de Contacto", desc: "Prueba y ajuste de lentes de contacto", icono: "🔬", duracion: "30 min" },
  { id: "control_oftalmologico", nombre: "Control Oftalmológico", desc: "Revisión oftalmológica profesional", icono: "🏥", duracion: "30 min" },
  { id: "consulta_general", nombre: "Consulta General", desc: "Consulta sobre cualquier tema visual", icono: "💬", duracion: "30 min" },
];
  ...
  return (
    <div className="ac-container">
      <div className="ac-header">
        ...
        <button className="ac-btn-secondary ac-ver-citas" onClick={() => setVerMisCitas(true)}>
          <FaEye /> Ver mis citas
        </button>
      </div>
        ...
        <div className="ac-paso">
          ...
          <div className="ac-servicios-grid">
            {SERVICIOS.map((s) => (
              ...
              >
                <span className="ac-servicio-icono">{s.icono}</span>
                <h3>{s.nombre}</h3>
                <p>{s.desc}</p>
        ...
        <div className="ac-paso">
          ...
          <div className="ac-fecha-hora-grid">
            <div className="ac-calendario">
              ...
              <div className="ac-cal-dias">
                {generarDiasMes().map((dia, i) => (
                  <button
                    key={i}
                    className={`ac-cal-dia ${!dia ? "empty" : ""} ${!esDiaValido(dia) ? "disabled" : ""} ${fechaSeleccionada === formatFecha(dia) ? "selected" : ""}`}
            ...
            <div className="ac-slots">
              ...
              {!fechaSeleccionada ? (
                <p className="ac-slots-hint">Selecciona una fecha para ver los horarios disponibles.</p>
              ) : loadingSlots ? (
      ...
      {paso === 3 && (
        <div className="ac-paso">
          ...
          <div className="ac-confirmacion">
            <div className="ac-resumen">
              <h3>Resumen</h3>
              <div className="ac-resumen-item">
                <FaClipboardList />
                <div>
                  <span className="ac-resumen-label">Servicio</span>
                  <span className="ac-resumen-value">{getServicioNombre(servicio)}</span>
                </div>
              </div>
              <div className="ac-resumen-item">
                <FaCalendarAlt />
                <div>
                  <span className="ac-resumen-label">Fecha</span>
                  <span className="ac-resumen-value">{fechaSeleccionada}</span>
                </div>
              </div>
              <div className="ac-resumen-item">
                <FaClock />
                <div>
                  <span className="ac-resumen-label">Hora</span>
                  <span className="ac-resumen-value">{horaSeleccionada}</span>
                </div>
              </div>
            </div>
